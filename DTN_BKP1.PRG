...
DO WHILE .T.
		...
		ELSE
		*Windows
		   	@ 2, 0 TO 2, 135 DOUBLE COLOR RGB(130,20,50)
   			@ 1, 30 SAY 'VOUCHER  DISPLAY - TYPE WISE ' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   			@ 1, 110 SAY 'PAGE #' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   			@ 1, 120 SAY PAGE PICTURE '999' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   			@ 26, 0 TO 26, 135 DOUBLE 
   			@ 22, 10 SAY '1 - ' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   			@ 23, 10 SAY '2 - ' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   			@ 22, 65 SAY '3 - ' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   			@ 23, 65 SAY '4 - ' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   			@ 24, 10 SAY '5 - ' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   			@ 24, 40 SAY '6 - ' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   			@ 24, 65 SAY '7 - ' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   			@ 22, 13 SAY 'Cash Receipt - ' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   			@ 23, 13 SAY 'Cash Payment - ' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   			@ 22, 69 SAY 'Bank Receipt - ' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   			@ 23, 69 SAY 'Bank Payment - ' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   			@ 24, 13 SAY 'Journal      - ' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   			@ 24, 44 SAY 'Sales - ' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   			@ 24, 69 SAY 'Purchase     - ' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
		...
		ELSE
		*Windows
   				@ 22, 34 SAY 'CR' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   				@ 23, 34 SAY 'CP' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   				@ 22, 90 SAY 'BR' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   				@ 23, 90 SAY 'BP' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   				@ 24, 34 SAY 'JV' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   				@ 24, 55 SAY 'SV' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
   				@ 24, 90 SAY 'PV' FONT 'FOXFONT',11 COLOR RGB(200,90,30)
		ENDIF
